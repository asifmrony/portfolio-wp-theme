...
<head>
  ...
  <title>Centrix | Creative Agency</title>
  <?php wp_head(); ?>
</head>

<body <?php body_class('webpage webpage--bg-white'); ?>>
              ...
              <nav class="navigation">
                <ul class="navigation__list">
                  <li class="navigation__item navigation__item--current">
                    <a class="navigation__link" href="agency-default.html">Home<span class="navigation__link-icon">
                    ...
                    <div class="navigation__dropdown">
                      <ul class="navigation__dropdown-list">
                        ...
                        <li class="navigation__dropdown-item navigation__dropdown-item--current">
                          <a>Creative agency<span class="navigation__dropdown-icon">
                              <svg width="12" height="13">
                                <use xlink:href="#link-arrow"></use>
                              </svg>
                            </span>
