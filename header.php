        ...
        <div class="header__mobile mobile-canvas">
          <nav class="mobile-canvas__nav navigation">
            <ul class="navigation__list">
              <li class="navigation__item <?php if(is_front_page()) echo 'navigation__item--current'; ?>">
                <a class="navigation__link" href="<?php echo site_url(); ?>">Home<span class="navigation__link-icon">
              ...
              <li class="navigation__item <?php if(is_page('about-us') or get_post_type() == 'service' or is_page('faq')) echo 'navigation__item--current'?>">
                <button class="navigation__link animsition-link">Explore<span class="navigation__link-icon">
                    <svg width="12" height="13">
                      <use xlink:href="#link-arrow"></use>
                    </svg>
                  </span>
                ...
                <div class="navigation__dropdown">
                  <ul class="navigation__dropdown-list">
                    <li class="navigation__dropdown-item <?php if(is_page('about-us')) echo 'navigation__dropdown-item--current'?>">
                      <a class="animsition-link" href="<?php echo site_url('/about-us'); ?>">About us<span class="navigation__dropdown-icon">
                          <svg width="12" height="13">
                            <use xlink:href="#link-arrow"></use>
                          </svg>
                        </span>
                    ...
                    <li class="navigation__dropdown-item <?php if(get_post_type() == 'service') echo 'navigation__dropdown-item--current'?>">
                      <a class="animsition-link" href="<?php echo get_post_type_archive_link('service'); ?>">Services<span class="navigation__dropdown-icon">
                          <svg width="12" height="13">
                            <use xlink:href="#link-arrow"></use>
                          </svg>
                        </span>
                    ...
                    <li class="navigation__dropdown-item <?php if(is_page('faq')) echo 'navigation__dropdown-item--current'; ?>">
                      <a class="animsition-link" href="<?php echo site_url('/faq'); ?>">Faq<span class="navigation__dropdown-icon">
                          <svg width="12" height="13">
                            <use xlink:href="#link-arrow"></use>
                          </svg>
                        </span>
              ...
              <li class="navigation__item <?php if(get_post_type() == 'project') echo 'navigation__item--current'?>">
                <a class="navigation__link animsition-link" href="<?php echo get_post_type_archive_link('project'); ?>">Projects<span class="navigation__link-icon">
                    <svg width="12" height="13">
                      <use xlink:href="#link-arrow"></use>
                    </svg>
                  </span>
              ...
              <li class="navigation__item <?php if(is_home() or (is_single() && 'post' == get_post_type())) echo 'navigation__item--current'; ?>">
                <a class="navigation__link animsition-link" href="<?php echo site_url('/blog'); ?>">Blog<span class="navigation__link-icon">
                    <svg width="12" height="13">
                      <use xlink:href="#link-arrow"></use>
                    </svg>
                  </span>
